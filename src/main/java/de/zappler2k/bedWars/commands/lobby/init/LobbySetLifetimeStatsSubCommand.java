...
public class LobbySetLifetimeStatsSubCommand extends SubCommand {

    private final BedWars plugin;
    private final LobbySetupManager lobbySetupManager;

    public LobbySetLifetimeStatsSubCommand(BedWars plugin, LobbySetupManager lobbySetupManager) {
        super("bedwars.admin.setup.lobby.setlifetimestats");
        this.plugin = plugin;
    ...
    public boolean executeSubCommand(CommandSender sender, String[] args) {
        ...
        lobbySetupManager.setLifetimeStatsBoardLocation(player, player.getLocation());
        player.sendMessage("§aLifetime stats board location has been set!");
        return true;
    }
